...
import { DELETE_ACCOUNT, EDIT_PROFILE, LINK_TRAINEE, LINK_TRAINER, PASSWORD_SETTINGS, PRIVACY_POLICY, PROFILE, REGISTER_TRAINER, SETTINGS } from "../constants/screenNames";
